...
class NormAttentionWithBias(nn.Module):
    """
    Attention module of LightningDiT.
    """
    def __init__(
        ...
        #############################################################################
        self.k_bias = nn.Parameter(torch.zeros(1, self.num_heads, 1, dim // self.num_heads), requires_grad=True)
        self.v_bias = nn.Parameter(torch.zeros(1, self.num_heads, 1, dim // self.num_heads), requires_grad=True)
