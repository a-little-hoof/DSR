#!/bin/bash
# Example SLURM launcher for sampling from the SigLIP2-B + DiT-XL test-time-register variant.
# Adjust the SBATCH directives for your cluster, or strip them out and run
# directly under torchrun.
#SBATCH --job-name=stage2_DiT-XL_SigLIP2-B_tt_reg_data_lognormal-in_context_36
...
torchrun --standalone --nnodes=1 --nproc_per_node=1 \
  ...
  --sample-dir sample_output/DiT-XL_SigLIP2-B_tt_reg_data_lognormal-in_context_36 \
  --precision bf16 \
